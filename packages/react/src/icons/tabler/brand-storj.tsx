...
// DO NOT edit this file. To modify the animation, edit scripts/animations/brand-storj.ts
// then re-run: pnpm generate --icon brand-storj
...
// Animation variants — defined in scripts/animations/brand-storj.ts
...
const BrandStorjIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export { BrandStorjIcon };
export type { LiveIconHandle as BrandStorjIconHandle };
