...
// DO NOT edit this file. To modify the animation, edit scripts/animations/ai-agent.ts
// then re-run: pnpm generate --icon ai-agent
...
// Animation variants — defined in scripts/animations/ai-agent.ts
...
const AiAgentIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export { AiAgentIcon };
export type { LiveIconHandle as AiAgentIconHandle };
