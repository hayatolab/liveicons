...
// DO NOT edit this file. To modify the animation, edit scripts/animations/flower-off.ts
// then re-run: pnpm generate --icon flower-off
...
// Animation variants — defined in scripts/animations/flower-off.ts
...
const FlowerOffIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
FlowerOffIcon.displayName = "FlowerOffIcon";

export { FlowerOffIcon };
export type { LiveIconHandle as FlowerOffIconHandle };
