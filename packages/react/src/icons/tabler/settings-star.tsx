...
// DO NOT edit this file. To modify the animation, edit scripts/animations/settings-star.ts
// then re-run: pnpm generate --icon settings-star
...
// Animation variants — defined in scripts/animations/settings-star.ts
...
const SettingsStarIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
SettingsStarIcon.displayName = "SettingsStarIcon";

export { SettingsStarIcon };
export type { LiveIconHandle as SettingsStarIconHandle };
