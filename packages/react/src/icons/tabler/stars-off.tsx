...
// DO NOT edit this file. To modify the animation, edit scripts/animations/stars-off.ts
// then re-run: pnpm generate --icon stars-off
...
// Animation variants — defined in scripts/animations/stars-off.ts
...
const StarsOffIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
StarsOffIcon.displayName = "StarsOffIcon";

export { StarsOffIcon };
export type { LiveIconHandle as StarsOffIconHandle };
