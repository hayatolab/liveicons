...
// DO NOT edit this file. To modify the animation, edit scripts/animations/square-f0.ts
// then re-run: pnpm generate --icon square-f0
...
// Animation variants — defined in scripts/animations/square-f0.ts
...
const SquareF0Icon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
SquareF0Icon.displayName = "SquareF0Icon";

export { SquareF0Icon };
export type { LiveIconHandle as SquareF0IconHandle };
