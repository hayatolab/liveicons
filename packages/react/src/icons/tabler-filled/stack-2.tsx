...
// DO NOT edit this file. To modify the animation, edit scripts/animations/stack-2.ts
// then re-run: pnpm generate --icon stack-2
...
// Animation variants — defined in scripts/animations/stack-2.ts
...
const Stack2Icon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
Stack2Icon.displayName = "Stack2Icon";

export { Stack2Icon };
export type { LiveIconHandle as Stack2IconHandle };
