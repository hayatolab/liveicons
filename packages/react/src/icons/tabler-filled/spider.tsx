...
// DO NOT edit this file. To modify the animation, edit scripts/animations/spider.ts
// then re-run: pnpm generate --icon spider
...
// Animation variants — defined in scripts/animations/spider.ts
...
const SpiderIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export { SpiderIcon };
export type { LiveIconHandle as SpiderIconHandle };
