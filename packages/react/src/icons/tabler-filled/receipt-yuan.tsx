...
// DO NOT edit this file. To modify the animation, edit scripts/animations/receipt-yuan.ts
// then re-run: pnpm generate --icon receipt-yuan
...
// Animation variants — defined in scripts/animations/receipt-yuan.ts
...
const ReceiptYuanIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
ReceiptYuanIcon.displayName = "ReceiptYuanIcon";

export { ReceiptYuanIcon };
export type { LiveIconHandle as ReceiptYuanIconHandle };
