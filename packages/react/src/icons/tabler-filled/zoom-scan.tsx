...
// DO NOT edit this file. To modify the animation, edit scripts/animations/zoom-scan.ts
// then re-run: pnpm generate --icon zoom-scan
...
// Animation variants — defined in scripts/animations/zoom-scan.ts
...
const ZoomScanIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
ZoomScanIcon.displayName = "ZoomScanIcon";

export { ZoomScanIcon };
export type { LiveIconHandle as ZoomScanIconHandle };
