...
// DO NOT edit this file. To modify the animation, edit scripts/animations/laurel-wreath-2.ts
// then re-run: pnpm generate --icon laurel-wreath-2
...
// Animation variants — defined in scripts/animations/laurel-wreath-2.ts
...
const LaurelWreath2Icon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export { LaurelWreath2Icon };
export type { LiveIconHandle as LaurelWreath2IconHandle };
