...
// DO NOT edit this file. To modify the animation, edit scripts/animations/laurel-wreath-1.ts
// then re-run: pnpm generate --icon laurel-wreath-1
...
// Animation variants — defined in scripts/animations/laurel-wreath-1.ts
...
const LaurelWreath1Icon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
LaurelWreath1Icon.displayName = "LaurelWreath1Icon";

export { LaurelWreath1Icon };
export type { LiveIconHandle as LaurelWreath1IconHandle };
