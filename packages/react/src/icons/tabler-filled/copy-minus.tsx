...
// DO NOT edit this file. To modify the animation, edit scripts/animations/copy-minus.ts
// then re-run: pnpm generate --icon copy-minus
...
// Animation variants — defined in scripts/animations/copy-minus.ts
...
const CopyMinusIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as CopyMinusIconHandle };
