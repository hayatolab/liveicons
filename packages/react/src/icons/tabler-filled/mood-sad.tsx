...
// DO NOT edit this file. To modify the animation, edit scripts/animations/mood-sad.ts
// then re-run: pnpm generate --icon mood-sad
...
// Animation variants — defined in scripts/animations/mood-sad.ts
...
const MoodSadIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export { MoodSadIcon };
export type { LiveIconHandle as MoodSadIconHandle };
