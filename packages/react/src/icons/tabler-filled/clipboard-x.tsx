...
// DO NOT edit this file. To modify the animation, edit scripts/animations/clipboard-x.ts
// then re-run: pnpm generate --icon clipboard-x
...
// Animation variants — defined in scripts/animations/clipboard-x.ts
...
const ClipboardXIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as ClipboardXIconHandle };
