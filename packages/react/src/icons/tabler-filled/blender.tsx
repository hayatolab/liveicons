...
// DO NOT edit this file. To modify the animation, edit scripts/animations/blender.ts
// then re-run: pnpm generate --icon blender
...
// Animation variants — defined in scripts/animations/blender.ts
...
const BlenderIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export { BlenderIcon };
export type { LiveIconHandle as BlenderIconHandle };
