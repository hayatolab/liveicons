...
// DO NOT edit this file. To modify the animation, edit scripts/animations/list.ts
// then re-run: pnpm generate --icon list
...
// Animation variants — defined in scripts/animations/list.ts
...
const ListIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export { ListIcon };
export type { LiveIconHandle as ListIconHandle };
