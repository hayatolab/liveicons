...
// DO NOT edit this file. To modify the animation, edit scripts/animations/info-circle.ts
// then re-run: pnpm generate --icon info-circle
...
// Animation variants — defined in scripts/animations/info-circle.ts
...
const InfoCircleIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as InfoCircleIconHandle };
