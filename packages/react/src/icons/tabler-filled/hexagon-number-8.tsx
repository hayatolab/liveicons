...
// DO NOT edit this file. To modify the animation, edit scripts/animations/hexagon-number-8.ts
// then re-run: pnpm generate --icon hexagon-number-8
...
// Animation variants — defined in scripts/animations/hexagon-number-8.ts
...
const HexagonNumber8Icon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
HexagonNumber8Icon.displayName = "HexagonNumber8Icon";

export { HexagonNumber8Icon };
export type { LiveIconHandle as HexagonNumber8IconHandle };
