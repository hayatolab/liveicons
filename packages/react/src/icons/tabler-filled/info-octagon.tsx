...
// DO NOT edit this file. To modify the animation, edit scripts/animations/info-octagon.ts
// then re-run: pnpm generate --icon info-octagon
...
// Animation variants — defined in scripts/animations/info-octagon.ts
...
const InfoOctagonIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as InfoOctagonIconHandle };
