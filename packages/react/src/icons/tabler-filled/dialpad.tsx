...
// DO NOT edit this file. To modify the animation, edit scripts/animations/dialpad.ts
// then re-run: pnpm generate --icon dialpad
...
// Animation variants — defined in scripts/animations/dialpad.ts
...
const DialpadIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export { DialpadIcon };
export type { LiveIconHandle as DialpadIconHandle };
