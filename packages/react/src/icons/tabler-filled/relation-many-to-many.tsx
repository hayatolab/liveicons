...
// DO NOT edit this file. To modify the animation, edit scripts/animations/relation-many-to-many.ts
// then re-run: pnpm generate --icon relation-many-to-many
...
// Animation variants — defined in scripts/animations/relation-many-to-many.ts
...
const RelationManyToManyIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export { RelationManyToManyIcon };
export type { LiveIconHandle as RelationManyToManyIconHandle };
