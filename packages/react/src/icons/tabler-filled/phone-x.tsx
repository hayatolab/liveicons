...
// DO NOT edit this file. To modify the animation, edit scripts/animations/phone-x.ts
// then re-run: pnpm generate --icon phone-x
...
// Animation variants — defined in scripts/animations/phone-x.ts
...
const PhoneXIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export { PhoneXIcon };
export type { LiveIconHandle as PhoneXIconHandle };
