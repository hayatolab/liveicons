...
// DO NOT edit this file. To modify the animation, edit scripts/animations/caret-left-right.ts
// then re-run: pnpm generate --icon caret-left-right
...
// Animation variants — defined in scripts/animations/caret-left-right.ts
...
const CaretLeftRightIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export { CaretLeftRightIcon };
export type { LiveIconHandle as CaretLeftRightIconHandle };
