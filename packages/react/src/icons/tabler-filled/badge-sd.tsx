...
// DO NOT edit this file. To modify the animation, edit scripts/animations/badge-sd.ts
// then re-run: pnpm generate --icon badge-sd
...
// Animation variants — defined in scripts/animations/badge-sd.ts
...
const BadgeSdIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export { BadgeSdIcon };
export type { LiveIconHandle as BadgeSdIconHandle };
