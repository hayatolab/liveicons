...
// DO NOT edit this file. To modify the animation, edit scripts/animations/fence.ts
// then re-run: pnpm generate --icon fence
...
// Animation variants — defined in scripts/animations/fence.ts
...
const FenceIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export { FenceIcon };
export type { LiveIconHandle as FenceIconHandle };
