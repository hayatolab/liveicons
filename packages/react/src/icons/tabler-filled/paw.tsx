...
// DO NOT edit this file. To modify the animation, edit scripts/animations/paw.ts
// then re-run: pnpm generate --icon paw
...
// Animation variants — defined in scripts/animations/paw.ts
...
const PawIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export { PawIcon };
export type { LiveIconHandle as PawIconHandle };
