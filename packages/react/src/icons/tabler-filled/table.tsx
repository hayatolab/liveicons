...
// DO NOT edit this file. To modify the animation, edit scripts/animations/table.ts
// then re-run: pnpm generate --icon table
...
// Animation variants — defined in scripts/animations/table.ts
...
const TableIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export { TableIcon };
export type { LiveIconHandle as TableIconHandle };
