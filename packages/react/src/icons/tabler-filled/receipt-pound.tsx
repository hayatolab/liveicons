...
// DO NOT edit this file. To modify the animation, edit scripts/animations/receipt-pound.ts
// then re-run: pnpm generate --icon receipt-pound
...
// Animation variants — defined in scripts/animations/receipt-pound.ts
...
const ReceiptPoundIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
ReceiptPoundIcon.displayName = "ReceiptPoundIcon";

export { ReceiptPoundIcon };
export type { LiveIconHandle as ReceiptPoundIconHandle };
