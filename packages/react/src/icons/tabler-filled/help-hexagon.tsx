...
// DO NOT edit this file. To modify the animation, edit scripts/animations/help-hexagon.ts
// then re-run: pnpm generate --icon help-hexagon
...
// Animation variants — defined in scripts/animations/help-hexagon.ts
...
const HelpHexagonIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export { HelpHexagonIcon };
export type { LiveIconHandle as HelpHexagonIconHandle };
