...
// DO NOT edit this file. To modify the animation, edit scripts/animations/artboard.ts
// then re-run: pnpm generate --icon artboard
...
// Animation variants — defined in scripts/animations/artboard.ts
...
const ArtboardIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export { ArtboardIcon };
export type { LiveIconHandle as ArtboardIconHandle };
