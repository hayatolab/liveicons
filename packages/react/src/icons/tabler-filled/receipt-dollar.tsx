...
// DO NOT edit this file. To modify the animation, edit scripts/animations/receipt-dollar.ts
// then re-run: pnpm generate --icon receipt-dollar
...
// Animation variants — defined in scripts/animations/receipt-dollar.ts
...
const ReceiptDollarIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export { ReceiptDollarIcon };
export type { LiveIconHandle as ReceiptDollarIconHandle };
