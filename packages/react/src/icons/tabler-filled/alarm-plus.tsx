...
// DO NOT edit this file. To modify the animation, edit scripts/animations/alarm-plus.ts
// then re-run: pnpm generate --icon alarm-plus
...
// Animation variants — defined in scripts/animations/alarm-plus.ts
...
const AlarmPlusIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export { AlarmPlusIcon };
export type { LiveIconHandle as AlarmPlusIconHandle };
