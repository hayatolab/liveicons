...
// DO NOT edit this file. To modify the animation, edit scripts/animations/hop.ts
// then re-run: pnpm generate --icon hop
...
// Animation variants — defined in scripts/animations/hop.ts
...
const HopIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export { HopIcon };
export type { LiveIconHandle as HopIconHandle };
