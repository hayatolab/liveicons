...
// DO NOT edit this file. To modify the animation, edit scripts/animations/bug-ant.ts
// then re-run: pnpm generate --icon bug-ant
...
// Animation variants — defined in scripts/animations/bug-ant.ts
...
const BugAntIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export { BugAntIcon };
export type { LiveIconHandle as BugAntIconHandle };
