...
// DO NOT edit this file. To modify the animation, edit scripts/animations/document-currency-euro.ts
// then re-run: pnpm generate --icon document-currency-euro
...
const DocumentCurrencyEuroIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as DocumentCurrencyEuroIconHandle };
