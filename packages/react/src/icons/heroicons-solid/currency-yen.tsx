...
// DO NOT edit this file. To modify the animation, edit scripts/animations/currency-yen.ts
// then re-run: pnpm generate --icon currency-yen
...
// Animation variants — defined in scripts/animations/currency-yen.ts
...
const CurrencyYenIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as CurrencyYenIconHandle };
