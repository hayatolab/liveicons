...
// DO NOT edit this file. To modify the animation, edit scripts/animations/server-stack.ts
// then re-run: pnpm generate --icon server-stack
...
// Animation variants — defined in scripts/animations/server-stack.ts
...
const ServerStackIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as ServerStackIconHandle };
