...
// DO NOT edit this file. To modify the animation, edit scripts/animations/document-arrow-down.ts
// then re-run: pnpm generate --icon document-arrow-down
...
// Animation variants — defined in scripts/animations/document-arrow-down.ts
...
const DocumentArrowDownIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as DocumentArrowDownIconHandle };
