...
// DO NOT edit this file. To modify the animation, edit scripts/animations/loader.ts
// then re-run: pnpm generate --icon loader
...
// Animation variants — defined in scripts/animations/loader.ts
...
const LoaderIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export { LoaderIcon };
export type { LiveIconHandle as LoaderIconHandle };
