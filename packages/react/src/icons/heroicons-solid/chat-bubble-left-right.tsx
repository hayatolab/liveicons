...
// DO NOT edit this file. To modify the animation, edit scripts/animations/chat-bubble-left-right.ts
// then re-run: pnpm generate --icon chat-bubble-left-right
...
// Animation variants — defined in scripts/animations/chat-bubble-left-right.ts
...
const ChatBubbleLeftRightIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as ChatBubbleLeftRightIconHandle };
