...
// DO NOT edit this file. To modify the animation, edit scripts/animations/cog-6-tooth.ts
// then re-run: pnpm generate --icon cog-6-tooth
...
// Animation variants — defined in scripts/animations/cog-6-tooth.ts
...
const Cog6ToothIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as Cog6ToothIconHandle };
