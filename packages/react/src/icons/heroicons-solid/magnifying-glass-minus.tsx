...
// DO NOT edit this file. To modify the animation, edit scripts/animations/magnifying-glass-minus.ts
// then re-run: pnpm generate --icon magnifying-glass-minus
...
// Animation variants — defined in scripts/animations/magnifying-glass-minus.ts
...
const MagnifyingGlassMinusIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as MagnifyingGlassMinusIconHandle };
