...
// DO NOT edit this file. To modify the animation, edit scripts/animations/arrows-up-down.ts
// then re-run: pnpm generate --icon arrows-up-down
...
// Animation variants — defined in scripts/animations/arrows-up-down.ts
...
const ArrowsUpDownIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as ArrowsUpDownIconHandle };
