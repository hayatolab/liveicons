...
// DO NOT edit this file. To modify the animation, edit scripts/animations/currency-euro.ts
// then re-run: pnpm generate --icon currency-euro
...
// Animation variants — defined in scripts/animations/currency-euro.ts
...
const CurrencyEuroIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as CurrencyEuroIconHandle };
