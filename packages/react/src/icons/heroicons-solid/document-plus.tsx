...
// DO NOT edit this file. To modify the animation, edit scripts/animations/document-plus.ts
// then re-run: pnpm generate --icon document-plus
...
// Animation variants — defined in scripts/animations/document-plus.ts
...
const DocumentPlusIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as DocumentPlusIconHandle };
