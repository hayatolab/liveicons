...
// DO NOT edit this file. To modify the animation, edit scripts/animations/clipboard-document.ts
// then re-run: pnpm generate --icon clipboard-document
...
// Animation variants — defined in scripts/animations/clipboard-document.ts
...
const ClipboardDocumentIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as ClipboardDocumentIconHandle };
