...
// DO NOT edit this file. To modify the animation, edit scripts/animations/speaker-wave.ts
// then re-run: pnpm generate --icon speaker-wave
...
// Animation variants — defined in scripts/animations/speaker-wave.ts
...
const SpeakerWaveIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as SpeakerWaveIconHandle };
