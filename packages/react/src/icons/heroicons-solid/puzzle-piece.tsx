...
// DO NOT edit this file. To modify the animation, edit scripts/animations/puzzle-piece.ts
// then re-run: pnpm generate --icon puzzle-piece
...
// Animation variants — defined in scripts/animations/puzzle-piece.ts
...
const PuzzlePieceIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as PuzzlePieceIconHandle };
