...
// DO NOT edit this file. To modify the animation, edit scripts/animations/document-currency-rupee.ts
// then re-run: pnpm generate --icon document-currency-rupee
...
// Animation variants — defined in scripts/animations/document-currency-rupee.ts
...
const DocumentCurrencyRupeeIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as DocumentCurrencyRupeeIconHandle };
