...
// DO NOT edit this file. To modify the animation, edit scripts/animations/globe-asia-australia.ts
// then re-run: pnpm generate --icon globe-asia-australia
...
// Animation variants — defined in scripts/animations/globe-asia-australia.ts
...
const GlobeAsiaAustraliaIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as GlobeAsiaAustraliaIconHandle };
