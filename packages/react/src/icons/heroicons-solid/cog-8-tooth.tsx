...
// DO NOT edit this file. To modify the animation, edit scripts/animations/cog-8-tooth.ts
// then re-run: pnpm generate --icon cog-8-tooth
...
// Animation variants — defined in scripts/animations/cog-8-tooth.ts
...
const Cog8ToothIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as Cog8ToothIconHandle };
