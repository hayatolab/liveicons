...
// DO NOT edit this file. To modify the animation, edit scripts/animations/magnifying-glass-plus.ts
// then re-run: pnpm generate --icon magnifying-glass-plus
...
// Animation variants — defined in scripts/animations/magnifying-glass-plus.ts
...
const MagnifyingGlassPlusIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as MagnifyingGlassPlusIconHandle };
