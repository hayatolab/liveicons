...
// DO NOT edit this file. To modify the animation, edit scripts/animations/document-currency-bangladeshi.ts
// then re-run: pnpm generate --icon document-currency-bangladeshi
...
// Animation variants — defined in scripts/animations/document-currency-bangladeshi.ts
...
const DocumentCurrencyBangladeshiIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as DocumentCurrencyBangladeshiIconHandle };
