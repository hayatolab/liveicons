...
// DO NOT edit this file. To modify the animation, edit scripts/animations/envelope.ts
// then re-run: pnpm generate --icon envelope
...
// Animation variants — defined in scripts/animations/envelope.ts
...
const EnvelopeIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export { EnvelopeIcon };
export type { LiveIconHandle as EnvelopeIconHandle };
