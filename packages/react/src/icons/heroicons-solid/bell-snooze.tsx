...
// DO NOT edit this file. To modify the animation, edit scripts/animations/bell-snooze.ts
// then re-run: pnpm generate --icon bell-snooze
...
// Animation variants — defined in scripts/animations/bell-snooze.ts
...
const BellSnoozeIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as BellSnoozeIconHandle };
