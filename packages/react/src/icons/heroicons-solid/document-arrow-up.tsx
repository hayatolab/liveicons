...
// DO NOT edit this file. To modify the animation, edit scripts/animations/document-arrow-up.ts
// then re-run: pnpm generate --icon document-arrow-up
...
// Animation variants — defined in scripts/animations/document-arrow-up.ts
...
const DocumentArrowUpIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as DocumentArrowUpIconHandle };
