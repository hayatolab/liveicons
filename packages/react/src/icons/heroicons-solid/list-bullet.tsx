...
// DO NOT edit this file. To modify the animation, edit scripts/animations/list-bullet.ts
// then re-run: pnpm generate --icon list-bullet
...
// Animation variants — defined in scripts/animations/list-bullet.ts
...
const ListBulletIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as ListBulletIconHandle };
