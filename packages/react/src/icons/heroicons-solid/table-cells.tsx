...
// DO NOT edit this file. To modify the animation, edit scripts/animations/table-cells.ts
// then re-run: pnpm generate --icon table-cells
...
// Animation variants — defined in scripts/animations/table-cells.ts
...
const TableCellsIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as TableCellsIconHandle };
