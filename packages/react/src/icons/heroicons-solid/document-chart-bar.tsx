...
// DO NOT edit this file. To modify the animation, edit scripts/animations/document-chart-bar.ts
// then re-run: pnpm generate --icon document-chart-bar
...
// Animation variants — defined in scripts/animations/document-chart-bar.ts
...
const DocumentChartBarIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as DocumentChartBarIconHandle };
