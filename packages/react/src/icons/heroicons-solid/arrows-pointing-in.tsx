...
// DO NOT edit this file. To modify the animation, edit scripts/animations/arrows-pointing-in.ts
// then re-run: pnpm generate --icon arrows-pointing-in
...
// Animation variants — defined in scripts/animations/arrows-pointing-in.ts
...
const ArrowsPointingInIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as ArrowsPointingInIconHandle };
