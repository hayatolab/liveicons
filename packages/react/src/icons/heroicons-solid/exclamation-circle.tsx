...
// DO NOT edit this file. To modify the animation, edit scripts/animations/exclamation-circle.ts
// then re-run: pnpm generate --icon exclamation-circle
...
// Animation variants — defined in scripts/animations/exclamation-circle.ts
...
const ExclamationCircleIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as ExclamationCircleIconHandle };
