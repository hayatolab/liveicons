...
// DO NOT edit this file. To modify the animation, edit scripts/animations/document-check.ts
// then re-run: pnpm generate --icon document-check
...
// Animation variants — defined in scripts/animations/document-check.ts
...
const DocumentCheckIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as DocumentCheckIconHandle };
