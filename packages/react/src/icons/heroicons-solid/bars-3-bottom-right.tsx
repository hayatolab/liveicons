...
// DO NOT edit this file. To modify the animation, edit scripts/animations/bars-3-bottom-right.ts
// then re-run: pnpm generate --icon bars-3-bottom-right
...
// Animation variants — defined in scripts/animations/bars-3-bottom-right.ts
...
const Bars3BottomRightIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as Bars3BottomRightIconHandle };
