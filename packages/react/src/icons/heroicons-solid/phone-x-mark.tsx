...
// DO NOT edit this file. To modify the animation, edit scripts/animations/phone-x-mark.ts
// then re-run: pnpm generate --icon phone-x-mark
...
// Animation variants — defined in scripts/animations/phone-x-mark.ts
...
const PhoneXMarkIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as PhoneXMarkIconHandle };
