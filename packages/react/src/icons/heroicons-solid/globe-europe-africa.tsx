...
// DO NOT edit this file. To modify the animation, edit scripts/animations/globe-europe-africa.ts
// then re-run: pnpm generate --icon globe-europe-africa
...
// Animation variants — defined in scripts/animations/globe-europe-africa.ts
...
const GlobeEuropeAfricaIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as GlobeEuropeAfricaIconHandle };
