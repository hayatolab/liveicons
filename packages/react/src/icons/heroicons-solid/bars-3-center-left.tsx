...
// DO NOT edit this file. To modify the animation, edit scripts/animations/bars-3-center-left.ts
// then re-run: pnpm generate --icon bars-3-center-left
...
// Animation variants — defined in scripts/animations/bars-3-center-left.ts
...
const Bars3CenterLeftIcon = forwardRef<LiveIconHandle, LiveIconProps>(
  (
    {
      animate = "on-hover",
      speed = "normal",
...
export type { LiveIconHandle as Bars3CenterLeftIconHandle };
